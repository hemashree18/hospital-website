    ...
    <div className="footer-section">
      <div className="footer-container">
        ...
        <div className="ft-list" id="contact">
          ...
          <ul className="ft-list-items">
            <li>
              <a href="mailto:mail@mail.com">support@healthplusexample.com</a>
            </li>
            <li>
              <a href="mailto:mail@mail.com">
                appointment@healthplusexample.com
              </a>
            </li>
            <li>
              <a href="tel:+0223 5454 5252">+0223 5454 5252</a>
            </li>
            <li>
              <a href="tel:+0223 2326 6232">+0223 2326 6232</a>
            </li>
          </ul>
        </div>
      </div>
